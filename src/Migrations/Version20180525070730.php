 ...
 */
final class Version20180525070730 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE recette (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, titre VARCHAR(25) NOT NULL, temps_preparation INT NOT NULL, nb_personnes INT NOT NULL, UNIQUE INDEX UNIQ_49BB6390FF7747B4 (titre), INDEX IDX_49BB6390A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
